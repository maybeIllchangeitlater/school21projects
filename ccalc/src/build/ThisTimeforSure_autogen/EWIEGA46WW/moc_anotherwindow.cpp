...
#include <memory>
#include "../../../ThisTimeForSure/anotherwindow.h"
...
QT_MOC_LITERAL(26, 0), // ""
QT_MOC_LITERAL(27, 16) // "on_Close_clicked"

    },
    "AnotherWindow\0firstWindow\0\0on_Close_clicked"
};
...
void AnotherWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AnotherWindow::firstWindow)) {
                *result = 0;
                return;
            }
        }
