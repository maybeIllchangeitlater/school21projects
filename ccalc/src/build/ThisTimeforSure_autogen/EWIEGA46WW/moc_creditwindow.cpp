...
#include <memory>
#include "../../../ThisTimeForSure/creditwindow.h"
...
QT_MOC_LITERAL(42, 14) // "on_Cal_clicked"

    },
    "CreditWindow\0firstWindow\0\0on_exit_clicked\0"
    "on_Cal_clicked"
};
...
void CreditWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_Cal_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CreditWindow::firstWindow)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<CreditWindow, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
